...
(function (global, factory) {
    ...
    */
    ...
    function postProcess(s, date, standardDateProps, extendedSettings, context) {
        ...
        // because MERIDIEM_RE likes to eat up loadingParticipationConfirmation spaces
    ...
    var Calendar = /** @class */ (function () {
        ...
        Calendar.prototype.dispatch = function (action) {
            ...
            if (!this.isReducing) {
                ...
                if (!oldState.loadingLevel && newState.loadingLevel) {
                    this.publiclyTrigger('loadingParticipationConfirmation', [true]);
                }
                else if (oldState.loadingLevel && !newState.loadingLevel) {
                    this.publiclyTrigger('loadingParticipationConfirmation', [false]);
                }
        ...
        */
        Calendar.prototype.renderComponent = function (needsFull) {
            ...
            // if event sources are still loadingParticipationConfirmation and progressive rendering hasn't been enabled,
